...
class StockEnvTrade(gym.Env):
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            plt.savefig('results/etf_70account_value_trade_{}_{}.png'.format(self.model_name, self.iteration))
            plt.close()
            df_total_value = pd.DataFrame(self.asset_memory)
            df_total_value.to_csv('results/etf_70account_value_trade_{}_{}.csv'.format(self.model_name, self.iteration))
            ...
            df_rewards.to_csv('results/etf_70account_rewards_trade_{}_{}.csv'.format(self.model_name, self.iteration))
            
            # print('total asset: {}'.format(self.state[0]+ sum(np.array(self.state[1:29])*np.array(self.state[29:]))))
            # with open('etf_70trade_obs.pkl', 'wb') as f:  
